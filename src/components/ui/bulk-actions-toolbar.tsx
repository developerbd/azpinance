...
export function BulkActionsToolbar({
    ...
    return (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 bg-background border rounded-lg shadow-lg p-2 flex items-center gap-4 animate-in slide-in-from-bottom-2">
